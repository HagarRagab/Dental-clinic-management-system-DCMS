...
const navigation: Record<UserRole, NavItem[]> = {
  ...
  dentist: [{ label: "Today", icon: LayoutDashboard, href: "/dashboard?role=dentist" }, { label: "Calendar", icon: CalendarDays, href: "/calendar?role=dentist" }, { label: "Patients", icon: Users, href: "/patients/mariam-adel?role=dentist" }, { label: "Clinical records", icon: ClipboardList, href: "/clinical/current-visit?role=dentist" }, { label: "Treatment plans", icon: FileText }],
};
